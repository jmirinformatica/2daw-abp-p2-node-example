# Codi d'exemple de nodejs

Codi d'exemple:

* [0-hello-world](./0-hello-world/): codi bàsic creat amb [express-generator](https://expressjs.com/en/starter/generator.html) i adaptat per fer servir [Nunjucks](https://mozilla.github.io/nunjucks/)
* [1-crud](./1-crud/): exemple de crud a partir del repositori https://github.com/adarsh-2425/simple-node-app
